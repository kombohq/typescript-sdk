...
```typescript
import { GetAtsApplicationsPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetAtsApplicationsPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetAtsApplicationsPositiveResponseResult](../models/getatsapplicationspositiveresponseresult.md)[]                              | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |