...
```typescript
import { PostAtsCandidatesCandidateIdResultLinksRequestBodyWorkable } from "@kombo-api/sdk/models";

let value: PostAtsCandidatesCandidateIdResultLinksRequestBodyWorkable = {};
```
