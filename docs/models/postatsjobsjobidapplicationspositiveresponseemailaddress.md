...
```typescript
import { PostAtsJobsJobIdApplicationsPositiveResponseEmailAddress } from "@kombo-api/sdk/models";

let value: PostAtsJobsJobIdApplicationsPositiveResponseEmailAddress = {
  type: "<value>",
};
```
