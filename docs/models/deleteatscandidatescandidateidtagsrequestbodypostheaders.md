...
```typescript
import { DeleteAtsCandidatesCandidateIdTagsRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: DeleteAtsCandidatesCandidateIdTagsRequestBodyPostHeaders = {};
```
