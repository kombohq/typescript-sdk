...
```typescript
import { PutAtsApplicationsApplicationIdStageRequestBodyWorkable } from "@kombo-api/sdk/models";

let value: PutAtsApplicationsApplicationIdStageRequestBodyWorkable = {};
```
