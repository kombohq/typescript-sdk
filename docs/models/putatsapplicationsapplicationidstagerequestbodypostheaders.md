...
```typescript
import { PutAtsApplicationsApplicationIdStageRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: PutAtsApplicationsApplicationIdStageRequestBodyPostHeaders = {};
```
