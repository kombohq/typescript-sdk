...
```typescript
import { PostAtsApplicationsApplicationIdResultLinksRequestBodyWorkable } from "@kombo-api/sdk/models";

let value: PostAtsApplicationsApplicationIdResultLinksRequestBodyWorkable = {};
```
