...
| `hiring_team_roles`                                                                                                              | [models.AssessmentOrderReceivedWebhookPayloadHiringTeamRole](../models/assessmentorderreceivedwebhookpayloadhiringteamrole.md)[] | :heavy_check_mark:                                                                                                               | Array of the roles of the user for this specific job.                                                                            |