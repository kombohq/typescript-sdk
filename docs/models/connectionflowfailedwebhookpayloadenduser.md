...
```typescript
import { ConnectionFlowFailedWebhookPayloadEndUser } from "@kombo-api/sdk/models";

let value: ConnectionFlowFailedWebhookPayloadEndUser = {
  organization_name: "<value>",
  creator_email: "Raquel32@gmail.com",
  origin_id: "<id>",
};
```
