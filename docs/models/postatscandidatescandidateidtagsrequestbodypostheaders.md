...
```typescript
import { PostAtsCandidatesCandidateIdTagsRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: PostAtsCandidatesCandidateIdTagsRequestBodyPostHeaders = {};
```
