...
```typescript
import { GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus } from "@kombo-api/sdk/models";

let value: GetToolsCategoryPositiveResponseReadModelFieldCoverageStatus =
  "UNKNOWN";
```
