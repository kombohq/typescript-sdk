...
```typescript
import { GetHrisTimeOffBalancesPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetHrisTimeOffBalancesPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetHrisTimeOffBalancesPositiveResponseResult](../models/gethristimeoffbalancespositiveresponseresult.md)[]                      | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |