...
```typescript
import { GetAtsNotesPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetAtsNotesPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetAtsNotesPositiveResponseResult](../models/getatsnotespositiveresponseresult.md)[]                                            | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |