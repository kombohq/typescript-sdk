...
| `hiring_team_roles`                                                                                                          | [models.GetAssessmentOrdersPositiveResponseHiringTeamRole](../models/getassessmentorderspositiveresponsehiringteamrole.md)[] | :heavy_check_mark:                                                                                                           | Array of the roles of the user for this specific job.                                                                        | [<br/>"RECRUITER"<br/>]                                                                                                      |