...
```typescript
import { GetHrisPerformanceReviewsPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetHrisPerformanceReviewsPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetHrisPerformanceReviewsPositiveResponseResult](../models/gethrisperformancereviewspositiveresponseresult.md)[]                | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |