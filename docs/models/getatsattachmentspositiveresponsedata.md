...
```typescript
import { GetAtsAttachmentsPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetAtsAttachmentsPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetAtsAttachmentsPositiveResponseResult](../models/getatsattachmentspositiveresponseresult.md)[]                                | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |