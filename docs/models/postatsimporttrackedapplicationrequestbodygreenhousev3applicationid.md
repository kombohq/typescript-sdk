...
```typescript
import { PostAtsImportTrackedApplicationRequestBodyGreenhousev3ApplicationID } from "@kombo-api/sdk/models";

let value: PostAtsImportTrackedApplicationRequestBodyGreenhousev3ApplicationID =
  {
