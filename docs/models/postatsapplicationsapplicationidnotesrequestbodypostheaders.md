...
```typescript
import { PostAtsApplicationsApplicationIdNotesRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: PostAtsApplicationsApplicationIdNotesRequestBodyPostHeaders = {};
```
