...
```typescript
import { PostAtsCandidatesCandidateIdResultLinksRequestBodyTalent360 } from "@kombo-api/sdk/models";

let value: PostAtsCandidatesCandidateIdResultLinksRequestBodyTalent360 = {
  user_id: "<id>",
};
```
