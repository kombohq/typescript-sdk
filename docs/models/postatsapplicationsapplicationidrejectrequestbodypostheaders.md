...
```typescript
import { PostAtsApplicationsApplicationIdRejectRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: PostAtsApplicationsApplicationIdRejectRequestBodyPostHeaders = {};
```
