...
| `hiring_team_roles`                                                                                                                          | [models.InlineAssessmentOrderReceivedWebhookPayloadHiringTeamRole](../models/inlineassessmentorderreceivedwebhookpayloadhiringteamrole.md)[] | :heavy_check_mark:                                                                                                                           | Array of the roles of the user for this specific job.                                                                                        |