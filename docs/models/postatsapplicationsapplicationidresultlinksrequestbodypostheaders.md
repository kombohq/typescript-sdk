...
```typescript
import { PostAtsApplicationsApplicationIdResultLinksRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: PostAtsApplicationsApplicationIdResultLinksRequestBodyPostHeaders =
  {};
```
