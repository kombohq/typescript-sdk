...
```typescript
import { IntegrationStateChangedWebhookPayloadEndUser } from "@kombo-api/sdk/models";

let value: IntegrationStateChangedWebhookPayloadEndUser = {
  organization_name: "<value>",
  creator_email: "Victor_Littel@hotmail.com",
  origin_id: null,
};
```
