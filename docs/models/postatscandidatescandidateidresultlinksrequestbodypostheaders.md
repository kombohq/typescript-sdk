...
```typescript
import { PostAtsCandidatesCandidateIdResultLinksRequestBodyPostHeaders } from "@kombo-api/sdk/models";

let value: PostAtsCandidatesCandidateIdResultLinksRequestBodyPostHeaders = {};
```
