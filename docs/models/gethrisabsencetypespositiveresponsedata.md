...
```typescript
import { GetHrisAbsenceTypesPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetHrisAbsenceTypesPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetHrisAbsenceTypesPositiveResponseResult](../models/gethrisabsencetypespositiveresponseresult.md)[]                            | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |