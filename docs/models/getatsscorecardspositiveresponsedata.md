...
```typescript
import { GetAtsScorecardsPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetAtsScorecardsPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetAtsScorecardsPositiveResponseResult](../models/getatsscorecardspositiveresponseresult.md)[]                                  | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |