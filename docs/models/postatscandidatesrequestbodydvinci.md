...
```typescript
import { PostAtsCandidatesRequestBodyDvinci } from "@kombo-api/sdk/models";

let value: PostAtsCandidatesRequestBodyDvinci = {};
```
...
| `candidate`                                                                                                                                                                           | Record<string, *any*>                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                                    | Fields that we will pass through to d.vinci's candidate/application payload as top-level fields (e.g., dateOfBirth).                                                                  |