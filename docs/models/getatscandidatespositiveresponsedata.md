...
```typescript
import { GetAtsCandidatesPositiveResponseData } from "@kombo-api/sdk/models";

let value: GetAtsCandidatesPositiveResponseData = {
  next:
...
| `results`                                                                                                                               | [models.GetAtsCandidatesPositiveResponseResult](../models/getatscandidatespositiveresponseresult.md)[]                                  | :heavy_check_mark:                                                                                                                      | N/A                                                                                                                                     |