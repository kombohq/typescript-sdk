...
```typescript
import { GetIntegrationsIntegrationIdPositiveResponseSetupStatus } from "@kombo-api/sdk/models";

let value: GetIntegrationsIntegrationIdPositiveResponseSetupStatus =
  "COMPLETED";
```
