...
```typescript
import { PostAtsJobsJobIdApplicationsRequestBodyConsentDecisions } from "@kombo-api/sdk/models";

let value: PostAtsJobsJobIdApplicationsRequestBodyConsentDecisions = {};
```
