...
export class ClientSDK {
  ...
  constructor(options: SDKOptions = {}) {
    ...
    this._baseURL = url;
    this.#httpClient = options.http_client || defaultHttpClient;

    this._options = { ...options, hooks: this.#hooks };

    this.#logger = this._options.debug_logger;
  }
  ...
  public _createRequest(
    ...
    if (!fetchOptions?.signal && conf.timeout_ms && conf.timeout_ms > 0) {
      const timeoutSignal = AbortSignal.timeout(conf.timeout_ms);
