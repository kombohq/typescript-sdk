 ...
 * Whether the application stage is active in the ATS. Inactive stages (also e.g., archived or hidden) may still be referenced by existing applications but are typically not part of the current hiring workflow.
 */
export type StageStatus = ClosedEnum<typeof StageStatus>;
...
/** @internal */
export const StageStatus$inboundSchema: z.ZodNativeEnum<typeof StageStatus> = z
  .nativeEnum(StageStatus);
...
export const Stage$inboundSchema: z.ZodType<Stage, z.ZodTypeDef, unknown> = z
  .object({
    ...
    status: z.nullable(StageStatus$inboundSchema),
