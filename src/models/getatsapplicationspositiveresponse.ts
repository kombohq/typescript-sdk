 ...
 */
export const CurrentStageStatus = {
  Active: "ACTIVE",
  Inactive: "INACTIVE",
} as const;
/**
 * Whether the application stage is active in the ATS. Inactive stages (also e.g., archived or hidden) may still be referenced by existing applications but are typically not part of the current hiring workflow.
 */
export type CurrentStageStatus = ClosedEnum<typeof CurrentStageStatus>;
...
export type GetAtsApplicationsPositiveResponseCurrentStage = {
   ...
   * Whether the application stage is active in the ATS. Inactive stages (also e.g., archived or hidden) may still be referenced by existing applications but are typically not part of the current hiring workflow.
   */
  status: CurrentStageStatus | null;
  /**
 ...
 * - `ABANDONED`: The offer has expired or is no longer valid and should not be considered.
 */
export type OfferStatus = ClosedEnum<typeof OfferStatus>;
...
/** @internal */
export const CurrentStageStatus$inboundSchema: z.ZodNativeEnum<
  typeof CurrentStageStatus
> = z.nativeEnum(CurrentStageStatus);
...
export const GetAtsApplicationsPositiveResponseCurrentStage$inboundSchema:
  ...
  > = z.object({
    ...
    remote_id: z.nullable(z.string()),
    name: z.nullable(z.string()),
    status: z.nullable(CurrentStageStatus$inboundSchema),
...
/** @internal */
export const OfferStatus$inboundSchema: z.ZodNativeEnum<typeof OfferStatus> = z
  .nativeEnum(OfferStatus);
...
export const Offer$inboundSchema: z.ZodType<Offer, z.ZodTypeDef, unknown> = z
  .object({
    id: z.string(),
    remote_id: z.nullable(z.string()),
    status: z.nullable(OfferStatus$inboundSchema),
  });
