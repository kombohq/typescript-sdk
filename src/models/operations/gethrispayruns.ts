...
export type GetHrisPayRunsGlobals = {
  /**
...
export type GetHrisPayRunsRequest = {
  /**
...
export type GetHrisPayRunsResponse = {
  result: models.GetHrisPayRunsPositiveResponse;
};

/** @internal */
export type GetHrisPayRunsRequest$Outbound = {
  cursor?: string | undefined;
  page_size: number;
...
/** @internal */
export const GetHrisPayRunsRequest$outboundSchema: z.ZodType<
  GetHrisPayRunsRequest$Outbound,
  z.ZodTypeDef,
...
export function getHrisPayRunsRequestToJSON(
  getHrisPayRunsRequest: GetHrisPayRunsRequest,
): string {
  return JSON.stringify(
    GetHrisPayRunsRequest$outboundSchema.parse(getHrisPayRunsRequest),
  );
}

/** @internal */
export const GetHrisPayRunsResponse$inboundSchema: z.ZodType<
  GetHrisPayRunsResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  Result: models.GetHrisPayRunsPositiveResponse$inboundSchema,
}).transform((v) => {
  return remap$(v, {
    "Result": "result",
  });
...
export function getHrisPayRunsResponseFromJSON(
  jsonString: string,
): SafeParseResult<GetHrisPayRunsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetHrisPayRunsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetHrisPayRunsResponse' from JSON`,
  );
}
