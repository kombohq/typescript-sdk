...
import { assessmentGetAssessmentOrders } from "../funcs/assessmentGetAssessmentOrders.js";
...
export class Assessment extends ClientSDK {
   ...
   */
  async getAssessmentOrders(
    request?: operations.GetAssessmentOrdersRequest | undefined,
    options?: RequestOptions,
  ): Promise<
    PageIterator<operations.GetAssessmentOrdersResponse, { cursor: string }>
  > {
    return unwrapResultIterator(assessmentGetAssessmentOrders(
      this,
      request,
      options,
    ));
