 ...
 */
export function generalTriggerSync(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.PostForceSyncRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/force-sync")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PostForceSyncPositiveResponse$inboundSchema),
