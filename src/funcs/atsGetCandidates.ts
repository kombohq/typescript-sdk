 ...
 */
export function atsGetCandidates(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetAtsCandidatesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsCandidatesRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsCandidatesResponse$inboundSchema, {
      key: "Result",
    }),
