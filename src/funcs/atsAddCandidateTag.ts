 ...
 * ```
 */
export function atsAddCandidateTag(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostAtsCandidatesCandidateIdTagsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.PostAtsCandidatesCandidateIdTagsRequestBody,
    { explode: true },
  );
  ...
  >(
    M.json(
      200,
      models.PostAtsCandidatesCandidateIdTagsPositiveResponse$inboundSchema,
    ),
