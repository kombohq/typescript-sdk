 ...
 * ```
 */
export function hrisCreateAbsence(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.PostHrisAbsencesRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PostHrisAbsencesPositiveResponse$inboundSchema),
