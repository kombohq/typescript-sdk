 ...
 */
export function atsGetInterviews(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetAtsInterviewsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsInterviewsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsInterviewsResponse$inboundSchema, {
      key: "Result",
    }),
