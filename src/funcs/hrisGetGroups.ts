...
export function hrisGetGroups(
  ...
  PageIterator<
    Result<
      operations.GetHrisGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisGroupsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHrisGroupsResponse$inboundSchema, {
      key: "Result",
    }),
