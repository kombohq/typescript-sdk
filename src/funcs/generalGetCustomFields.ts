 ...
 */
export function generalGetCustomFields(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIntegrationsIntegrationIdCustomFieldsRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.GetIntegrationsIntegrationIdCustomFieldsResponse$inboundSchema,
      { key: "Result" },
    ),
