 ...
 */
export function generalDeleteIntegration(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteIntegrationsIntegrationIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      models.DeleteIntegrationsIntegrationIdPositiveResponse$inboundSchema,
    ),
