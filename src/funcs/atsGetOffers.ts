...
export function atsGetOffers(
  ...
  PageIterator<
    Result<
      operations.GetAtsOffersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsOffersRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsOffersResponse$inboundSchema, {
      key: "Result",
    }),
