 ...
 */
export function generalGetTools(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetToolsCategoryRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    category: encodeSimple("category", payload.category, {
      explode: false,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetToolsCategoryPositiveResponse$inboundSchema),
