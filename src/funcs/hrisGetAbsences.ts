 ...
 */
export function hrisGetAbsences(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetHrisAbsencesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisAbsencesRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/hris/absences")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHrisAbsencesResponse$inboundSchema, {
      key: "Result",
    }),
