 ...
 */
export function atsGetAtsScorecards(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetAtsScorecardsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsScorecardsRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/ats/scorecards")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsScorecardsResponse$inboundSchema, {
      key: "Result",
    }),
