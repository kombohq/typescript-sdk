 ...
 */
export function hrisGetHrisPayRuns(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetHrisPayRunsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisPayRunsRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/hris/pay-runs")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHrisPayRunsResponse$inboundSchema, {
      key: "Result",
    }),
