...
export function atsGetAtsNotes(
  ...
  PageIterator<
    Result<
      operations.GetAtsNotesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsNotesRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/ats/notes")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsNotesResponse$inboundSchema, {
      key: "Result",
    }),
