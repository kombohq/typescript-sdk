 ...
 * ```
 */
export function atsAddApplicationResultLink(
  client: KomboCore,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.PostAtsApplicationsApplicationIdResultLinksRequestBody,
    { explode: true },
  );
  ...
  const path = pathToFunc("/ats/applications/{application_id}/result-links")(
    pathParams,
  );
