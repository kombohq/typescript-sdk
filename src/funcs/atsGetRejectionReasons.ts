 ...
 */
export function atsGetRejectionReasons(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetAtsRejectionReasonsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsRejectionReasonsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/ats/rejection-reasons")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsRejectionReasonsResponse$inboundSchema, {
      key: "Result",
    }),
