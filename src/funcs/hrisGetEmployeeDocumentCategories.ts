 ...
 */
export function hrisGetEmployeeDocumentCategories(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisEmployeeDocumentCategoriesRequest$outboundSchema
  ...
  const path = pathToFunc("/hris/employee-document-categories")();
  ...
  >(
    M.json(
      200,
      operations.GetHrisEmployeeDocumentCategoriesResponse$inboundSchema,
      { key: "Result" },
    ),
