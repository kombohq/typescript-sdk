 ...
 */
export function hrisGetEmployments(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetHrisEmploymentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisEmploymentsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/hris/employments")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHrisEmploymentsResponse$inboundSchema, {
      key: "Result",
    }),
