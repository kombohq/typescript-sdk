 ...
 */
export function generalGetIntegrationDetails(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIntegrationsIntegrationIdRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      models.GetIntegrationsIntegrationIdPositiveResponse$inboundSchema,
    ),
