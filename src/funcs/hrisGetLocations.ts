 ...
 */
export function hrisGetLocations(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetHrisLocationsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisLocationsRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/hris/locations")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHrisLocationsResponse$inboundSchema, {
      key: "Result",
    }),
