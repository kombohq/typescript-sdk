 ...
 */
export function hrisGetAbsenceTypes(
  client: KomboCore,
  ...
  PageIterator<
    Result<
      operations.GetHrisAbsenceTypesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisAbsenceTypesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/hris/absence-types")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHrisAbsenceTypesResponse$inboundSchema, {
      key: "Result",
    }),
