 ...
 * ```
 */
export function atsAddApplicationNote(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostAtsApplicationsApplicationIdNotesRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.PostAtsApplicationsApplicationIdNotesRequestBody,
    { explode: true },
  );
