 ...
 * ```
 */
export function assessmentSetPackages(
  client: KomboCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.PutAssessmentPackagesRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PutAssessmentPackagesPositiveResponse$inboundSchema),
