...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsTagsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsTagsResponse$inboundSchema, { key: "Result" }),
