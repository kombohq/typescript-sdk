...
export function atsGetUsers(
  ...
  PageIterator<
    Result<
      operations.GetAtsUsersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAtsUsersRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/ats/users")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAtsUsersResponse$inboundSchema, {
      key: "Result",
    }),
