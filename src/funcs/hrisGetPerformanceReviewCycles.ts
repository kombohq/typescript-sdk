...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHrisPerformanceReviewCyclesRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/hris/performance-review-cycles")();
  ...
  >(
    M.json(
      200,
      operations.GetHrisPerformanceReviewCyclesResponse$inboundSchema,
      { key: "Result" },
    ),
